...
def start(update, context):
    ...
    if update.message.chat.type == "private" :
        sendMessage(f"Hey! <b>{update.message.chat.first_name}</b>. Welcome to <b>KickAss Torrents™ Search Bot</b>", context.bot, update)
    else :
    ...
    if not CustomFilters.authorized_user(update):
        sendMessage("This Bot Only Works At @KickAssTorrents™", context.bot, update)
